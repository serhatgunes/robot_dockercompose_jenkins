...
node {
    ...
    stage('Execute') {
       ...
       if (isUnix()) {
                ...
                sh './wait-for-grid.sh && docker exec test-execution
                pabot --pabotlib --processes 2 --outputdir ./reports --argumentfile1 Firefox.args --argumentfile2 Chrome.args test/ui_tests.robot'
            }
        else {
